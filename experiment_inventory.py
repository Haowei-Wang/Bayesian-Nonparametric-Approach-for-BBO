...
parser.add_argument('-t', '--time', type=str,
                    help='Date of the experiments, e.g. 20201109', default='20240909')
...
file_pre = '_'.join(["outputs/bo", time_run, "alpha", str(alpha),
                    "n_rep", str(n_rep), problem, method, true_dist[0].get('dist')])
